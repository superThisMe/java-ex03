...
//		//}
//		// enhanced for의 내부 동작
//		Iterator<String> iter = al.iterator(); // Iterator : java의 반복에 대한 표준
...
//		for (String key : keys) {//목록에서 다음 데이터가 있으면 데이터를 읽어서 str 저장
//			String value = al.get(key);//목록에서 key로 검색된 데이터 반환
...
//		 //load : 파일에서 데이터를 읽고 Properties로 가져오는 메소드
...
//		stack.push("a;dklja;sldkjfa;sdfjl"); // push : 앞에서부터 데이터 추가 (상입)
...
//		
//		while (queue.size() > 0) {
//			System.out.println(queue.poll());	// poll : 처번째 데이터를 읽고 목록에서 제거
